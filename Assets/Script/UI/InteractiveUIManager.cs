...
namespace GameFramework.UI
{
    public class InteractiveUIManager : SimpleSingleton<InteractiveUIManager>
    {
        ...
        {
            // Bind input
            InputSystem.BindKey(KeyCode.F, InputSystem.InputEventType.IE_Pressed, InteractiveWithTargetItem);
            InputSystem.BindKey(KeyCode.UpArrow, InputSystem.InputEventType.IE_Pressed, PointerUp);
            InputSystem.BindKey(KeyCode.DownArrow, InputSystem.InputEventType.IE_Pressed, PointerDown);
